...
<body>
  ...
  <section class="formulario-contenedor">
    <h2 class="titulo-centro">🎯 Agregar Nuevo Torneo</h2>

    <form action="guardar_torneo.php" method="POST" enctype="multipart/form-data" class="formulario-vertical">
      ...
      <button type="submit" class="btn">Guardar Torneo</button>
    </form>
  </section>
