...
<body>
  ...
  <header class="header">
    ...
    <nav>
      <ul>
        ...
        <li><a href="panel.php">Mi Cuenta</a></li>
        <li><a href="contactos.php">Contacto</a></li> <!-- ✅ Enlace agregado -->
      </ul>
    </nav>
  </header>
  ...
  <!-- NOTICIAS (DESACTIVADAS TEMPORALMENTE) -->
  <!--
  ...
  <section class="torneos">
    ...
    <div class="card-container">
      <?php
      $torneos = $conn->query("SELECT * FROM torneos ORDER BY fecha_inicio DESC");
