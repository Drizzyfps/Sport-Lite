...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['token']) && isset($_POST['nueva_contrasena']) && isset($_POST['confirmar_nueva_contrasena'])) {
        ...
        require 'conexion.php'; // ¡CAMBIO REALIZADO!
        ...
        try {
            ...
            if ($usuario) {
                ...
                if ($nueva_contrasena === $confirmar_nueva_contrasena) {
                    ...
                    // 4. Actualizar la contraseña del usuario en la base de datos y eliminar el token
                    ...
                    // 5. Mostrar mensaje de éxito y redirigir al inicio de sesión
