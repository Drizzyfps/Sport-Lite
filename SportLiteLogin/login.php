...
<body>
        ...
        <div class="tarjeta-login-sportlite">
            ...
            <div class="opciones-login-sportlite">
                <div style="display: flex; align-items: center; justify-content: space-between;">
                    <div id="boton-google-login"></div>
                    <p class="separador-login-sportlite"><span>O</span></p>
                    <button id="boton-facebook-login" class="boton-facebook-login-sportlite">
    ...
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/es_ES/sdk.js#xfbml=1&version=v13.0&appId=206406912409764&autoLogAppEvents=1" nonce=""></script>

    <script src="https://accounts.google.com/gsi/client"></script>

    <script src="js/login_social.js"></script>
</body>
</html>
